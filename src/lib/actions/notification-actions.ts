...
export const markNotificationRead = async (
  ...
  await setNotificationReadAt(input, new Date());

export const markNotificationUnread = async (
  input: unknown
): Promise<NotificationActionState> => await setNotificationReadAt(input, null);
...
export const updateHandoverRecipients = async (
  ...
  await db
    .insert(appSetting)
    .values({ key: HANDOVER_RECIPIENT_IDS_KEY, value, updatedAt: new Date() })
    .onConflictDoUpdate({
