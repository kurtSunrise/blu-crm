...
const STATIC_ROUTES = [
  ...
  { path: "/reports/trends", name: "trends report" },
  { path: "/reports/funnel", name: "funnel report" },
  { path: "/reports/team", name: "team report" },
  { path: "/reports/deals", name: "report drill-down" },
