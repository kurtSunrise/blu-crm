...
// shadcn/ui chart primitives (Recharts wrapper), adapted to house style:
// named imports, module-level row components, stable keys.
...
`
  ...
  return (
    // biome-ignore lint/security/noDangerouslySetInnerHtml: injects per-chart CSS variables built from the local ChartConfig, no user input
